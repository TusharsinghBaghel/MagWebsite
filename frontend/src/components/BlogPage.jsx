...
const BlogPage = () => {
  ...
  useEffect(() => {
    axios.get(`${BASE_URL}/blogs/get`)
      ...
      .catch(error => {
        ...
        setLoading(false); // This ensures that if the request fails, it still shows the content (possibly empty or an error message)
      });
  }, []);
  ...
  return (
    <section id="blog" className="blog section">
      ...
      {/* Blog List Section (only visible after loading is complete) */}
      {!loading && (
